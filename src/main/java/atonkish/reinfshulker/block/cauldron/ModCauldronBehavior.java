...
public class ModCauldronBehavior {
  // NOTE: 26.2 replaced the old public CauldronBehavior.WATER_CAULDRON_BEHAVIOR.map() with
  // CauldronInteractions.WATER, a Dispatcher whose backing maps and put() method are
  // package-private (no public registration API). Reflection + setAccessible(true) is the
  // verified working fix (EkagraTheBeast/reinforced-shulker-boxes#107).
